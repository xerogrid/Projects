...
class BusyBarControlTests(unittest.TestCase):
    def test_message_payload_targets_both_display_sizes(self) -> None:
        ...
        self.assertEqual([element.x for element in payload.elements], [36, 80])
        self.assertTrue(all(element.align == "top_mid" for element in payload.elements))
    ...
    def test_signage_payload_contains_booth_copy(self) -> None:
        ...
        self.assertEqual(
            [element.x for element in payload.elements],
            [36, 80, 80],
        )
