...
//========================================
// Assign arduino pins
#define pixelPin 4                // Pixels are on this pin
const int chinPanPin = 5;         // Chin pan servo is on this pin
const int eyePanPin = 6;          // ...
const int eyeTiltPin = 7;
const int sensorPanPin = 8;
